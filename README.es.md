...
- **Dashboard multi-cadena** — la tarjeta Market Lending consulta en un único request todas las cadenas soportadas por Morpho. La lista vigente se mantiene en [src/lib/chains.ts](src/lib/chains.ts).
